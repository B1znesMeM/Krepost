...
$q = $db->prepare("INSERT INTO `items` (`title`, `description`, `price`, `image`, `image_two`, `image_three`, `image_four`, `image_five`, `image_six`, `image_seven`, `image_eight`, `image_nine`, `image_ten`, `image_eleven`, `image_twelve`, `type_action`, `address`, `type`, `count_rooms`, `square_house`, `square_earth`,`floor_house`, `category_earth`, `material_wall`, `communications`, `repaire`, `method_sale`, `distance`, `distance_from` , `square_all`, `living_area`, `floor`, `balcony`, `additionally`, `height_ceillings`, `bathroom`, `windows`, `underfloor_heating`, `furniture`, `technic`, `type_transaction`, `square`) VALUES (:title, :description, :price, :image, :image_two, :image_three, :image_four, :image_five, :image_six, :image_seven, :image_eight, :image_nine, :image_ten, :image_eleven, :image_twelve, :type_action, :address, :type, :count_rooms, :square_house, :square_earth, :floor_house, :category_earth, :material_wall, :communications, :repaire, :method_sale, :distance, :distance_from, :square_all, :living_area, :floor, :balcony, :additionally, :height_ceillings, :bathroom, :windows, :underfloor_heating, :furniture, :technic, :type_transaction, :square)");
...
try{
    $q->execute([
        ...
        'image_five' => isset($item_five) ? $item_five : '',
